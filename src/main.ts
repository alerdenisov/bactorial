...
class Game {
  ...
  init() {
    ...
    for (let x = 0; x < side; x++) {
      for (let y = 0; y < side; y++) {
        ...
        // this.positions[index * 2 + 0] = (Math.random() * 2. - 1.) *
        // window.innerWidth;
        // this.positions[index * 2 + 1] = (Math.random() * 2. - 1.) *
        // window.innerHeight;//
  ...
  updateLabels(dt: number) {
    for (let index = 0; index < this.COUNT; index++) {
      ...
      // this.labels[index].position.set(position.x, position.y +
      // this.radiuses[index] * 0.5, 0);
    }
  }
    ...
    for (let index = 0; index < this.COUNT; index++) {
      ...
      for (let other = 0; other < this.COUNT; other++) {
        ...
        let p2 = new THREE.Vector2(
          this.positions[other * 2 + 0],
          this.positions[other * 2 + 1]
        );
